...
export const EMAIL = 'simp@gmail.com'

export const WEB_TITLE = 'KoAiSimpBangToi - Personal Website'
export const WEB_DESCRIPTION =
  'A personal website showcasing my work and projects.'
export const FOOTER_COPYRIGHT = '© 2025 KoAiSimpBangToi.'
export const FOOTER_LINK = 'https://github.com/username/'

export const NAME = 'KoAiSimpBangToi'
export const JOB_TITLE = 'DevOps intern'
